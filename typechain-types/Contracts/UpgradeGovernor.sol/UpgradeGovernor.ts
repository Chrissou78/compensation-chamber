...
export declare namespace UpgradeGovernor {
  export type ProposalState_ExtendedStruct = {
    severity: BigNumberish;
    thresholdReachedAt: BigNumberish;
    readyForExecutionAt: BigNumberish;
    thresholdMet: boolean;
    executed: boolean;
  };

  export type ProposalState_ExtendedStructOutput = [
    severity: bigint,
...
export interface UpgradeGovernorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
  ...
  encodeFunctionData(
    functionFragment: "PASSAGE_THRESHOLD",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "proposeWithSeverity",
  ...
  encodeFunctionData(
    functionFragment: "timeUntilExecutable",
    values: [BigNumberish]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "variableTimelock",
    values?: undefined
  ): string;
...
export namespace ProposalCreatedWithSeverityEvent {
  export type InputTuple = [
    proposalId: BigNumberish,
    severity: BigNumberish,
    description: string
...
export namespace ProposalExecutedWithCooldownEvent {
...
export namespace ProposalReadyForExecutionEvent {
  export type InputTuple = [proposalId: BigNumberish, timestamp: BigNumberish];
  export type OutputTuple = [proposalId: bigint, timestamp: bigint];
  export interface OutputObject {
    proposalId: bigint;
...
export namespace ThresholdReachedEvent {
  export type InputTuple = [
    proposalId: BigNumberish,
    timestamp: BigNumberish,
    severity: BigNumberish,
    cooldownEndsAt: BigNumberish
  ];
  export type OutputTuple = [
    proposalId: bigint,
    timestamp: bigint,
...
export interface UpgradeGovernor extends BaseContract {
  connect(runner?: ContractRunner | null): UpgradeGovernor;
  waitForDeployment(): Promise<this>;

  interface: UpgradeGovernorInterface;
  ...
  PASSAGE_THRESHOLD: TypedContractMethod<[], [bigint], "view">;
  ...
  getProposalState: TypedContractMethod<
    [proposalId: BigNumberish],
    [UpgradeGovernor.ProposalState_ExtendedStructOutput],
    "view"
  >;
  ...
  isReadyForExecution: TypedContractMethod<
    [proposalId: BigNumberish],
    [boolean],
    "view"
  >;
  ...
  proposalStates: TypedContractMethod<
    [arg0: BigNumberish],
    [
  ...
  proposeWithSeverity: TypedContractMethod<
    [
      targets: AddressLike[],
      values: BigNumberish[],
      calldatas: BytesLike[],
  ...
  timeUntilExecutable: TypedContractMethod<
    [proposalId: BigNumberish],
    [bigint],
    "view"
  >;
  ...
  variableTimelock: TypedContractMethod<[], [string], "view">;
  ...
  getFunction(
    nameOrSignature: "PASSAGE_THRESHOLD"
  ...
  >;
  getFunction(
    nameOrSignature: "isReadyForExecution"
  ...
  >;
  getFunction(
    nameOrSignature: "proposeWithSeverity"
  ): TypedContractMethod<
    [
      targets: AddressLike[],
      values: BigNumberish[],
  ...
  getFunction(
    nameOrSignature: "timeUntilExecutable"
  ): TypedContractMethod<[proposalId: BigNumberish], [bigint], "view">;
  getFunction(
  ...
  >;
  getFunction(
    nameOrSignature: "variableTimelock"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
  ...
  >;
  getEvent(
    key: "ProposalCreatedWithSeverity"
  ): TypedContractEvent<
    ProposalCreatedWithSeverityEvent.InputTuple,
    ProposalCreatedWithSeverityEvent.OutputTuple,
    ProposalCreatedWithSeverityEvent.OutputObject
  >;
  getEvent(
  ...
  >;
  getEvent(
    key: "ProposalExecutedWithCooldown"
  ): TypedContractEvent<
    ProposalExecutedWithCooldownEvent.InputTuple,
    ProposalExecutedWithCooldownEvent.OutputTuple,
    ProposalExecutedWithCooldownEvent.OutputObject
  >;
  getEvent(
    key: "ProposalQueued"
  ): TypedContractEvent<
  ...
  >;
  getEvent(
    key: "ProposalReadyForExecution"
  ): TypedContractEvent<
    ProposalReadyForExecutionEvent.InputTuple,
    ProposalReadyForExecutionEvent.OutputTuple,
    ProposalReadyForExecutionEvent.OutputObject
  >;
  getEvent(
  ...
  getEvent(
    ...
    ThresholdReachedEvent.InputTuple,
    ThresholdReachedEvent.OutputTuple,
    ThresholdReachedEvent.OutputObject
  >;
  getEvent(
    key: "TimelockChange"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "ProposalCreatedWithSeverity(uint256,uint8,string)": TypedContractEvent<
      ProposalCreatedWithSeverityEvent.InputTuple,
      ProposalCreatedWithSeverityEvent.OutputTuple,
      ProposalCreatedWithSeverityEvent.OutputObject
    >;
    ProposalCreatedWithSeverity: TypedContractEvent<
      ProposalCreatedWithSeverityEvent.InputTuple,
      ProposalCreatedWithSeverityEvent.OutputTuple,
      ProposalCreatedWithSeverityEvent.OutputObject
    >;
    ...
    "ProposalExecutedWithCooldown(uint256,uint256)": TypedContractEvent<
      ProposalExecutedWithCooldownEvent.InputTuple,
      ProposalExecutedWithCooldownEvent.OutputTuple,
      ProposalExecutedWithCooldownEvent.OutputObject
    >;
    ProposalExecutedWithCooldown: TypedContractEvent<
      ProposalExecutedWithCooldownEvent.InputTuple,
      ProposalExecutedWithCooldownEvent.OutputTuple,
      ProposalExecutedWithCooldownEvent.OutputObject
    >;
    ...
    "ProposalReadyForExecution(uint256,uint256)": TypedContractEvent<
      ProposalReadyForExecutionEvent.InputTuple,
      ProposalReadyForExecutionEvent.OutputTuple,
      ProposalReadyForExecutionEvent.OutputObject
    >;
    ProposalReadyForExecution: TypedContractEvent<
      ProposalReadyForExecutionEvent.InputTuple,
      ProposalReadyForExecutionEvent.OutputTuple,
      ProposalReadyForExecutionEvent.OutputObject
    >;
    ...
    "ThresholdReached(uint256,uint256,uint8,uint256)": TypedContractEvent<
      ThresholdReachedEvent.InputTuple,
      ThresholdReachedEvent.OutputTuple,
      ThresholdReachedEvent.OutputObject
    >;
    ThresholdReached: TypedContractEvent<
      ThresholdReachedEvent.InputTuple,
      ThresholdReachedEvent.OutputTuple,
      ThresholdReachedEvent.OutputObject
    >;
